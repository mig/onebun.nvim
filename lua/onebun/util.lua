local util = {}
local nord = require("onebun.theme")
...
-- Only define onebun if it's the active colorscheme
function util.onColorScheme()
	if vim.g.colors_name ~= "onebun" then
		vim.cmd([[autocmd! onebun]])
		vim.cmd([[augroup! onebun]])
	end
end
...
util.contrast = function()
	vim.cmd([[augroup onebun]])
	vim.cmd([[  autocmd!]])
	vim.cmd([[  autocmd ColorScheme * lua require("onebun.util").onColorScheme()]])
